...
@section('content')
    ...
    <div style="display:none" id="id_token">
      ...
      <pre><code>  ID Token: <span id="id_token_display"><a onclick="showIDToken();">(click here to pull from URL fragment)</a></span> </code></pre>
    </div>
...
<code>  // function to parse fragment and return access token
  function getAccessToken() {
    ...
    <div id="request_resource" style="display:none">
        ...
        <a class="button" href="{{ url('client/request_resource') }}" onclick="this.href += '?token='+getAccessToken().access_token;">make a resource request</a>
